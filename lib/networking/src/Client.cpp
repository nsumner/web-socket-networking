...
void Client::ClientImpl::send(std::string message)
{
...
namespace networking
{
  ...
  private:
    void connect(boost::asio::ip::basic_resolver_results<boost::asio::ip::tcp> endpoint);
...
void Client::ClientImpl::connect(boost::asio::ip::basic_resolver_results<boost::asio::ip::tcp> endpoint)
{
...
void Client::ClientImpl::reportError(std::string_view /*message*/) const
{
